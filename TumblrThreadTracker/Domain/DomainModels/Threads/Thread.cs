...
namespace TumblrThreadTracker.Domain.Threads
{
    ...
    public class Thread
    {
        ...
        public static IEnumerable<int?> GetThreadIdsByBlogId(int? blogId, IRepository<Thread> threadRepository)
        {
            ...
            IEnumerable<Thread> threads = threadRepository.Get(t => t.UserBlogId == blogId);
        ...
        {
            Thread thread = threadRepository.Get(id);
            Blog blog = blogRepository.Get(thread.UserBlogId);
